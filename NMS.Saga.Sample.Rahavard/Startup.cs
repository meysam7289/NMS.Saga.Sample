...
using NMS.Saga.Sample.Rahavard.Courier;
using NMS.Saga.Sample.Rahavard.DataLayer;

namespace NMS.Saga.Sample.Rahavard
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContextPool<RahavardDbContext>(opt =>
            {
            ...
            services.AddMassTransit(x =>
            {
                ...
                {
                    cfg.ReceiveEndpoint("Rahavard_Coding_Insert", e =>
                    {
                        e.PrefetchCount = 100;
                        e.ExecuteActivityHost<InsertCodingActivity, Coding>(new Uri(RabbitMqConstants.RabbitMqUri + "Comp_Rahavard_Coding_Insert"), services.BuildServiceProvider(),
                              c => c.UseRetry(r => r.Immediate(5)));
                    });
                    cfg.ReceiveEndpoint("Comp_Rahavard_Coding_Insert", e =>
                    {
                        e.PrefetchCount = 100;
